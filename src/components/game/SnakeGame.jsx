    ...
    <div className="bg-gradient-to-br from-accent-teal/20 to-accent-blue/20 p-4 md:p-6 lg:p-8 rounded-lg backdrop-blur-sm border border-accent-teal/30 w-full max-w-[420px]">
      <div className="relative">
              ...
              {gameOver && (
                <div className={`absolute inset-0 flex items-center justify-center ${theme === 'dark' ? 'bg-dark-secondary/90' : 'bg-light-secondary/90'}`}>
                  <div className="text-center">
                    ...
                    <button
                      onClick={resetGame}
                      className="bg-accent-orange hover:bg-accent-orange/80 text-dark-bg px-4 md:px-6 py-2 rounded text-sm md:text-base"
                    >
                      restart
                    </button>
                  </div>
        ...
        <div className="text-right text-xs md:text-sm space-y-1">
          ...
          <p>// arrows to play</p>
          <div className="flex justify-end items-center gap-1 md:gap-2 mt-4">
            <button className={`w-7 h-7 md:w-8 md:h-8 rounded border flex items-center justify-center text-xs md:text-sm ${theme === 'dark'
        ...
        <button
          ...
          className={`mt-4 border px-4 md:px-6 py-2 rounded transition-colors text-sm ${theme === 'dark'
