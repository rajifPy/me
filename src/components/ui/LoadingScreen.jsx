...
export default function LoadingScreen({ onComplete }) {
  ...
  const BOOT_SEQUENCE = [
    { text: '> initializing portfolio.exe', delay: 200 },
    { text: '> loading asset modules...', delay: 600 },
    { text: '> mounting react components...', delay: 1000 },
    { text: '> connecting database layer...', delay: 1400 },
    { text: '> calibrating ML pipeline...', delay: 1800 },
    { text: '> all systems nominal', delay: 2300 },
    { text: '> welcome, user', delay: 2700 },
  ]
