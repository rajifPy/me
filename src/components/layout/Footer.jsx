...
export default function Footer() {
  ...
  return (
    <footer className={`border-t ${borderClass} px-4 md:px-6 py-3 flex flex-col sm:flex-row
      items-center justify-between gap-2 text-xs md:text-sm flex-shrink-0`}>
      ...
      <div className="flex items-center gap-3 md:gap-4">
        ...
        <a
          href="https://linkedin.com/in/muhammadrajifalfarikhi"
          target="_blank"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className={`flex items-center gap-2 hover:text-accent-teal sm:border-l
          ${borderClass} sm:pl-4 transition-colors`}
      >
