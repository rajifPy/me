  ...
  return (
    <div className="max-w-6xl flex flex-col lg:flex-row items-center gap-8 lg:gap-16 w-full">
      <div className="flex-1 min-w-[280px] w-full">
        ...
        <h1 
          className={`text-3xl md:text-4xl lg:text-5xl mb-1 md:mb-2 font-normal ${
            theme === 'dark' ? 'text-white' : 'text-gray-900'
        ...
        <h1 
          className={`text-3xl md:text-4xl lg:text-5xl mb-4 md:mb-6 font-normal ${
            theme === 'dark' ? 'text-white' : 'text-gray-900'
          } ${showContent ? 'animate-slide-bounce' : 'opacity-0'}`}
        ...
        {/* ✅ Bagian krusial: typewriter */}
        <p className="text-accent-blue text-lg md:text-xl lg:text-2xl mb-8 md:mb-12 lg:mb-16">
          <span 
            className={`text-accent-teal ${showContent ? 'animate-fade-in' : 'opacity-0'}`} 
            style={{ animationDelay: '0.7s' }}
          >
            &gt;
          </span>{' '}
          <span
            className={`${showContent ? 'typewriter-role' : 'invisible opacity-0'}`}
            style={{ 
              animationDelay: '0.9s',
